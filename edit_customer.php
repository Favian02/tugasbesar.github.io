<?php
    include "koneksi.php";
    $id = $_GET['idcustomer'];
    $ambilData = mysqli_query($connect, "SELECT * FROM customer WHERE idcustomer='$id'");
...
<?php
        if(isset($_POST['simpan']))
        {
            ...
            mysqli_query($connect, "UPDATE customer 
            SET nama='$nama', telp='$telp', alamat='$alamat', kota='$kota', kodepos='$kodepos'
            WHERE idcustomer='$id'") or die(mysqli_error($connect));
